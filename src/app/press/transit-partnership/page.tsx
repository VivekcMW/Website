        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-mw-gray-600 leading-relaxed mb-8">
              Major partnership expands MWWST's out-of-home advertising network to 25 new metropolitan areas, reaching over 100 million daily commuters worldwide.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="text-mw-gray-700 space-y-6">
              <p className="text-lg font-medium text-mw-gray-900">
                NEW YORK, NY - September 12, 2024 - MWWST today announced a landmark partnership with the Global Transit Authority Network (GTAN), significantly expanding its out-of-home advertising capabilities across 25 major metropolitan areas worldwide.
              </p>

              <p>
                This strategic alliance will provide MWWST with exclusive advertising access to premium transit locations including subway systems, bus networks, and transit hubs in cities across North America, Europe, and Asia, reaching an estimated 100 million daily commuters.
              </p>
              ...
              <p>
                As part of this partnership, MWWST will deploy state-of-the-art digital displays throughout the transit network, featuring dynamic content capabilities and real-time optimization based on passenger flow, weather conditions, and local events.
              </p>

              <p>
                "This partnership represents a significant evolution in out-of-home advertising," said Maria Santos, VP of Strategic Partnerships at MWWST. "We're not just placing static ads in transit locations—we're creating dynamic, contextually relevant experiences that provide value to both advertisers and commuters."
              </p>

              <h2 className="text-2xl font-bold text-mw-gray-900 mt-8 mb-4">Technology Integration</h2>
              
              <p>
                MWWST will integrate its proprietary AI-powered targeting technology with transit data to deliver highly relevant advertising content. The system will analyze factors including:
              </p>
              ...
              <p>
                "Transit advertising has always been about reaching people during their daily routines," said Dr. James Wright, GTAN Executive Director. "Our partnership with MWWST brings this medium into the digital age, creating opportunities for more relevant, engaging, and effective advertising experiences."
              </p>

              <h2 className="text-2xl font-bold text-mw-gray-900 mt-8 mb-4">Rollout Timeline</h2>
              
              <p>
                The partnership will be implemented in phases, beginning with tier-one markets in Q1 2025. MWWST expects the full network to be operational by Q3 2025, with advanced features including mobile integration and augmented reality capabilities launching in select markets by year-end.
              </p>
