    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Trusted by Media Owners Worldwide
            </h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "The dynamic pricing engine alone increased our revenue by 28%. Best decision we made this year.",
                author: "Sarah Chen",
                role: "VP Operations, Urban Displays",
                rating: 5
              },
              {
                quote: "We filled 95% of our inventory within 3 months. The automated marketplace works flawlessly.",
                author: "James Wilson",
                role: "Owner, Highway Media Group",
                rating: 5
              },
              {
                quote: "Real-time analytics give us insights we never had before. Game-changing platform.",
                author: "Maria Rodriguez",
                role: "Director, Premier Outdoor",
                rating: 5
              }
