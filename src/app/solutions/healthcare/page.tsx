...
export default function HealthcarePage() {
  const benefits = [
    {
      icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3l7 7-7 7-7-7 7-7z" /></svg>,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-mw-blue-100 rounded-full mb-6">
                <span className="text-mw-blue-600 text-sm font-medium">Healthcare Marketing</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-mw-gray-900 mb-6">
                Connect with Patients
                <span className="text-mw-blue-600 block">Effectively</span>
              </h1>
              <p className="text-lg text-mw-gray-600 mb-8 leading-relaxed">
                Build trust, increase awareness, and drive patient engagement with healthcare advertising 
                that reaches your community where they live, work, and travel.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-mw-gray-900 mb-4">
              Why Healthcare Providers Choose MWWST
            </h2>
