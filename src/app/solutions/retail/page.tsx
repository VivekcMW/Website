  ...
  const benefits = [
    {
      ...
      description: "Drive more customers to your physical locations with targeted OOH campaigns"
    },
    {
      ...
      title: "Boost Sales",
      description: "Convert awareness into purchases with strategic placement and timing"
    },
    {
      icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 3a4 4 0 018 0v4a4 4 0 01-8 0V3zM9 17a2 2 0 114 0v4a2 2 0 11-4 0v-4z" /><circle cx="12" cy="12" r="3" /></svg>,
      title: "Target Shoppers",
      description: "Reach customers when they're in shopping mode near retail locations"
    },
    {
      ...
      description: "Connect offline advertising with online experiences seamlessly"
    }
  ];
  ...
  const caseStudies = [
    {
      ...
      metric: "45% increase",
      description: "in store visits during campaign period"
    },
    {
      brand: "Electronics Chain", 
      metric: "32% boost",
      description: "in weekend sales with targeted mall advertising"
    },
    {
      brand: "Home Goods Store",
      metric: "28% growth", 
      description: "in brand awareness among target demographics"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-mw-blue-100 rounded-full mb-6">
                <span className="text-mw-blue-600 text-sm font-medium">Retail & E-commerce</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-mw-gray-900 mb-6">
                Drive Foot Traffic & 
                <span className="text-mw-blue-600 block">Boost Sales</span>
              </h1>
              <p className="text-lg text-mw-gray-600 mb-8 leading-relaxed">
                Transform your retail advertising with strategic out-of-home campaigns that connect with shoppers 
                at the right moment, driving them from awareness to your store entrance.
              </p>
