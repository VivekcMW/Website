        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-mw-blue-100 rounded-full mb-8">
              <span className="text-mw-blue-600 text-sm font-medium">About MWWST</span>
            </div>
            ...
            <p className="text-xl text-mw-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              From a bold vision to market leadership, discover how MWWST transformed 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-mw-gray-600 mb-6 leading-relaxed">
                At MWWST, we believe advertising should be more than just reaching audiences—it should 
            ...
            >
              <div className="bg-gradient-to-br from-mw-blue-50 to-mw-blue-100 rounded-2xl p-8">
                ...
                <cite className="text-mw-blue-600 font-semibold">— MWWST Leadership Team</cite>
              </div>
            </motion.div>
          </div>
        </div>
