          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {pressReleases.map((release, index) => (
              ...
              >
                ...
                <Link href={
                  index === 0 ? "/press/ai-powered-audience-targeting" :
                  index === 1 ? "/press/series-c-funding" :
                  index === 2 ? "/press/transit-partnership" :
                  index === 3 ? "/press/adtech-company-of-year" :
                  index === 4 ? "/press/privacy-first-measurement" :
