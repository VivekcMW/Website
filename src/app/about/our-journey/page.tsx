  ...
  const timelineMilestones = [
    {
      ...
      description: "MWWST was born from a vision to revolutionize advertising through data-driven insights and innovative technology platforms.",
    ...
    },
    {
      ...
      description: "Opened international offices in London, Toronto, and Sydney, establishing MWWST as a global advertising technology leader.",
    ...
    },
    {
      ...
      description: "Launched MWWST 3.0 with advanced analytics, cross-platform integration, and enhanced automation capabilities.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-mw-blue-100 rounded-full mb-8">
              <span className="text-mw-blue-600 text-sm font-medium">The MWWST Story</span>
            </div>
            ...
            <p className="text-xl text-mw-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              Discover the remarkable story of how MWWST transformed from a bold startup vision 
