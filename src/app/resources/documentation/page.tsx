        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-mw-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive guides and technical documentation for the MWWST platform.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white border border-mw-gray-200 rounded-xl p-8">
                ...
                <div className="prose max-w-none">
                  <h3 className="text-2xl font-bold text-mw-gray-900 mt-8 mb-4">Getting Started with MWWST</h3>
                  <p className="text-mw-gray-600 mb-6">
                    Welcome to MWWST! This guide will help you get up and running with our advertising platform in minutes.
                  </p>
                  ...
                  <div className="bg-mw-gray-50 rounded-lg p-6 mb-6">
                    <ol className="list-decimal list-inside space-y-2 text-mw-gray-700">
                      <li>Log in to your MWWST account</li>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <Link href="/resources/help-center" className="flex items-center gap-3 p-4 bg-mw-gray-50 rounded-lg hover:bg-mw-blue-50 transition-colors">
                    ...
                    <Link href="/resources/api-reference" className="flex items-center gap-3 p-4 bg-mw-gray-50 rounded-lg hover:bg-mw-blue-50 transition-colors">
                      <svg className="w-8 h-8 text-mw-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                      <div>
                        <p className="font-semibold text-mw-gray-900">API Reference</p>
                        <p className="text-sm text-mw-gray-600">Developer docs</p>
                      </div>
                    </Link>
                  </div>
                </div>
