        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <nav className="flex items-center gap-2 text-sm text-mw-gray-500 mb-8">
              <Link href="/resources/blog" className="hover:text-mw-blue-600 transition-colors">
                Blog
              </Link>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
              <span className="text-mw-gray-700">{post.category}</span>
            </nav>

            {/* Category Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-mw-blue-100 rounded-full mb-6">
              <span className="text-mw-blue-600 text-sm font-medium">{post.category}</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pb-8 border-b border-mw-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {post.authorRole && (
                    <p className="text-sm text-mw-gray-500">{post.authorRole}</p>
                  )}
                </div>
              </div>
        ...
        <section className="py-8">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="aspect-video rounded-2xl overflow-hidden shadow-mw-xl bg-mw-gray-100"
            >
              <img
        ...
        <section className="py-8 border-t border-mw-gray-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-sm font-medium text-mw-gray-700">Tags:</span>
              {post.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-mw-gray-100 text-mw-gray-700 text-sm rounded-full hover:bg-mw-gray-200 transition-colors cursor-pointer"
                >
                  {tag}
                </span>
              ))}
      ...
      <section className="py-8 border-t border-mw-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-sm font-medium text-mw-gray-700">Share this article:</span>
      ...
      {relatedPosts.length > 0 && (
        <section className="py-16 bg-mw-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-mw-gray-900 mb-8">Related Articles</h2>
