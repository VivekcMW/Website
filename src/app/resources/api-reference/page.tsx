        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-mw-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Build powerful integrations with the MWWST API. Full REST API documentation and SDKs.
            </p>
            <div className="flex gap-4 justify-center">
              ...
              <Link href="/resources/documentation" className="px-6 py-3 border border-mw-gray-300 text-mw-gray-700 font-medium rounded-lg hover:bg-mw-gray-50 transition-colors">
                View Documentation
              </Link>
            </div>
          </motion.div>
