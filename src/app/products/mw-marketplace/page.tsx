  ...
  { 
    ...
    logo: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M6 12l4 6 8-12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    )
  },
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-16 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative w-full h-[500px] bg-gradient-to-br from-blue-950/50 to-indigo-950/50 rounded-2xl border-2 border-white/20 overflow-hidden mb-8">
            {/* Map background grid */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-leading security and trusted by the world&apos;s top brands
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
              {[
                { 
                  name: 'Nike',
                  logo: (
                    <svg viewBox="0 0 100 35" className="h-8 w-auto">
                ...
                { 
                  ...
                  logo: (
                    <svg viewBox="0 0 100 100" className="h-10 w-auto">
                      <path fill="#E82127" d="M50 0L30 20h15v75h10V20h15L50 0z"/>
                      <text x="50" y="95" fill="#E82127" fontSize="20" fontWeight="bold" textAnchor="middle" fontFamily="Arial">TESLA</text>
                    </svg>
                  )
                },
                { 
                  ...
                  logo: (
                    <svg viewBox="0 0 100 30" className="h-7 w-auto">
                      <path fill="#FF9900" d="M60 22c-6 4.5-14.5 7-22 7-10.5 0-20-4-27-10.5-.5-.5 0-1.2.6-.8 8 4.5 17.5 7.3 27.5 7.3 6.7 0 14.2-1.4 21-4.3 1-.5 2 .7 1 1.3z"/>
                      <path fill="#FF9900" d="M63 18.5c-.8-1-5-1-7.5-.5-2.5.5-6 3-5.5 3.5s.5 0 2-.5c1.5-.5 5-1 6.5-.5s2 1.5 1.5 2c-.5.5-3.5 3-4 3.5-.5.5 0 1 .5.5 3-2 6-4 5.5-5.5-.5-1.5-1.5-2-2.5-3z"/>
                      <text x="38" y="16" fill="#000" fontSize="18" fontWeight="bold" fontFamily="Arial">amazon</text>
                    </svg>
                  )
                },
                { 
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow flex items-center justify-center h-24"
                >
                  {brand.logo}
                </motion.div>
              ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: 'Active Buyers', value: '12,000+', color: 'from-blue-600 to-cyan-600' },
              { label: 'Customer Rating', value: '4.9/5', color: 'from-yellow-500 to-orange-500' },
              { label: 'ISO Certified', value: '27001', color: 'from-green-600 to-emerald-600' },
              { label: 'Uptime', value: '99.9%', color: 'from-purple-600 to-pink-600' }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                ...
                viewport={{ once: true }}
                className={`bg-gradient-to-br ${stat.color} p-8 rounded-2xl text-white shadow-xl hover:shadow-2xl transition-all text-center`}
              >
          ...
          >
            {['PCI DSS Compliant', 'GDPR Compliant', 'SSL Secured', 'SOC 2 Type II'].map((badge, index) => (
              <div
                key={index}
                className="bg-white px-6 py-3 rounded-full shadow-md text-sm font-semibold text-gray-700 flex items-center gap-2"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {['DSPs', 'SSPs', 'Ad Servers', 'Analytics'].map((category) => (
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <GlobeIcon className="w-20 h-20 mx-auto mb-6 text-yellow-300" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-yellow-400 to-orange-500 text-slate-900 px-10 py-5 rounded-xl font-bold text-lg hover:from-yellow-300 hover:to-orange-400 transition-all shadow-2xl hover:shadow-yellow-500/50 inline-flex items-center justify-center gap-3"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-white text-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-white hover:text-blue-900 transition-colors"
              >
                List Your Billboard
              </motion.button>
            </div>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>147 Countries</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckIcon className="w-5 h-5 text-green-400" />
                <span>250,000+ Billboards</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckIcon className="w-5 h-5 text-green-400" />
                <span>$4.2B Monthly Volume</span>
              </div>
            </div>
          </motion.div>
        </div>
