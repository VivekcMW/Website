        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                { label: "Total Formats", value: "24+", icon: "📊" },
                { label: "Active Campaigns", value: "7,716", icon: "🎯" },
                { label: "Daily Reach", value: "31.2M", icon: "👁️" },
                { label: "Avg Performance", value: "+21%", icon: "📈" }
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                  initial={{ scale: 0 }}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Understand how weather, traffic, events, and other contextual factors 
              impact your OOH campaign performance in real-time.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                metric: "+15%",
                description: "Engagement increase on sunny days",
              ...
              },
              {
                ...
                title: "Traffic Flow",
                metric: "2.4M",
                description: "Vehicles per day at peak locations",
                color: "from-blue-500 to-indigo-500"
              },
              {
                ...
                title: "Time of Day",
                metric: "7-9 AM",
                description: "Peak commute exposure window",
                color: "from-purple-500 to-pink-500"
              },
              {
                ...
                title: "Local Events",
                metric: "47",
                description: "Events tracked near your OOH",
                color: "from-pink-500 to-rose-500"
              }
            ].map((item, index) => (
              <motion.div
