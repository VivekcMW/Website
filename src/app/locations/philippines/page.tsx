  ...
  const keyMarkets = [
    {
      ...
      description: "The capital region and economic heart of the Philippines with the famous EDSA corridor.",
      locations: [
        { name: "EDSA Corridor", desc: "Main Highway", traffic: 1850000, screens: 586, score: 98 },
        { name: "BGC Taguig", desc: "Business District", traffic: 1250000, screens: 385, score: 97 },
        { name: "Makati CBD", desc: "Financial Hub", traffic: 1120000, screens: 325, score: 96 },
        { name: "SM Mall of Asia", desc: "Mega Mall", traffic: 920000, screens: 245, score: 95 },
      ],
      audience: [
    ...
    },
    {
      ...
      topCategory: "Tourism & BPO",
      viewability: 89.5,
      hourlyData: [12, 30, 72, 92, 85, 62, 52, 58, 72, 85, 88, 78, 65, 68, 78, 88, 95, 92, 75, 52, 35, 22, 15, 10],
      description: "The Queen City of the South, a major tourism and BPO hub in the Visayas.",
      locations: [
        { name: "IT Park", desc: "BPO Hub", traffic: 580000, screens: 186, score: 94 },
        { name: "Ayala Center Cebu", desc: "Shopping Complex", traffic: 520000, screens: 165, score: 93 },
      ],
      audience: [
        { name: "BPO Workers", percentage: 35, color: "bg-blue-500" },
      ...
      mediaFormats: [
        ...
        { name: "Transit Screens", percentage: 16 },
    ...
    },
    {
      ...
      topCategory: "Agriculture & Trade",
      viewability: 88.2,
      hourlyData: [10, 28, 68, 88, 82, 58, 48, 55, 68, 82, 85, 75, 62, 65, 75, 85, 92, 88, 72, 48, 32, 20, 12, 10],
      description: "Mindanao's largest city and a key gateway to the southern Philippines.",
      locations: [
        { name: "SM Lanang", desc: "Regional Mall", traffic: 420000, screens: 145, score: 92 },
        { name: "Downtown Davao", desc: "City Center", traffic: 380000, screens: 125, score: 90 },
      ],
      audience: [
        { name: "Families", percentage: 38, color: "bg-emerald-500" },
        { name: "Professionals", percentage: 28, color: "bg-blue-500" },
        { name: "Students", percentage: 20, color: "bg-purple-500" },
        { name: "Tourists", percentage: 14, color: "bg-amber-500" },
      ],
      mediaFormats: [
    ...
    },
    {
      ...
      yoyGrowth: 48.8,
      avgDwell: "3.2 min",
      peakHours: "9-12 PM, 4-8 PM",
      topCategory: "Logistics & Tourism",
      viewability: 87.5,
      hourlyData: [15, 25, 55, 75, 85, 78, 68, 72, 78, 85, 88, 82, 75, 72, 78, 85, 92, 88, 75, 55, 38, 25, 18, 15],
      description: "A rapidly growing economic zone and former US military base with major infrastructure.",
      locations: [
        { name: "Clark Freeport", desc: "Economic Zone", traffic: 320000, screens: 125, score: 91 },
        { name: "SM Clark", desc: "Regional Mall", traffic: 280000, screens: 98, score: 89 },
      ],
      audience: [
        { name: "Tourists", percentage: 35, color: "bg-amber-500" },
        { name: "Business Travelers", percentage: 28, color: "bg-blue-500" },
        { name: "Families", percentage: 22, color: "bg-emerald-500" },
        { name: "Workers", percentage: 15, color: "bg-purple-500" },
      ],
      mediaFormats: [
        { name: "Airport Media", percentage: 38 },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="mb-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Real-time outdoor advertising metrics across the Philippines</p>
            </div>
                ...
                <div className="relative">
                  ...
                  <div className="ml-8">
                    ...
                    <div className="flex items-end justify-between h-40 gap-0.5 relative">
                      <motion.div className="absolute z-20 group cursor-pointer" style={{ left: `${currentTimePosition}%`, bottom: '0' }} initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
                        <div className="absolute bottom-full mb-3 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"><div className="bg-gray-900 text-white text-xs font-medium px-3 py-2 rounded-lg shadow-lg"><div className="flex items-center gap-2"><span className="text-red-400">●</span><span>Current Time: {currentTimeLabel}</span></div></div><div className="absolute left-1/2 -translate-x-1/2 -bottom-1 w-2 h-2 bg-gray-900 rotate-45" /></div>
                        <div className="relative -translate-x-1/2"><span className="absolute inline-flex h-4 w-4 rounded-full bg-red-400 opacity-75 animate-ping" /><span className="relative inline-flex h-4 w-4 rounded-full bg-red-500 border-2 border-white shadow-lg" /></div>
                      </motion.div>
                      {currentMarket.hourlyData.map((value, i) => {
                        const isPeak = value >= 85; const hour = i; const isCurrentHour = hour === currentHour; const timeLabel = hour === 0 ? '12AM' : hour < 12 ? `${hour}AM` : hour === 12 ? '12PM' : `${hour - 12}PM`;
