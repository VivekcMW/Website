          ...
          <div className="mb-16">
            ...
            <div className="max-w-2xl">
              <Link href="/" className="inline-block mb-6">
                <span className="text-3xl font-bold text-white">MWWST</span>
              </Link>
              <p className="text-mw-gray-300 text-lg mb-6 leading-relaxed">
                Revolutionizing out-of-home advertising with cutting-edge technology, 
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
                <p className="text-mw-gray-400 text-sm">
                  © {new Date().getFullYear()} MWWST. All rights reserved.
                </p>
