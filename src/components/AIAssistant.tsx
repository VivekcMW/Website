...
export default function AIAssistant() {
  ...
  const generateAIResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('contact') || lowerMessage.includes('sales') || lowerMessage.includes('talk')) {
      return "Absolutely! You can reach our team multiple ways: Call +1 (844) MW-WORLD, email connect@mwwst.com, or visit our contact page. Our sales team typically responds within 2 hours. Would you prefer I schedule a call for you?";
    }
