...
// Fade Up Animation - slides up and fades in
...
// Scale In Animation - scales up and fades in
...
// Fade Left Animation - slides from left
...
// Fade Right Animation - slides from right
...
export function AnimatedSection({ children, className = '', delay = 0 }: AnimationProps) {
  const ref = useRef(null);
